...
<h4>Active Directory <img width="966" height="729" alt="Usuarios Active Directory" src="https://github.com/user-attachments/assets/c3d8a3ad-f841-44be-9b2f-cec213960b0e" /></h4>

### 2. Restrições via GPO Aplicadas
Bloqueio do Prompt de Comando (CMD) e Painel de Controle para usuários do domínio.
<h4>Testes GPO <img width="966" height="720" alt="Grupos Active Directory" src="https://github.com/user-attachments/assets/2fcedce6-f2a4-47d8-845a-9006ca41a979" /><h4>

### 3. Validação de Permissões NTFS e Compartilhamento
Teste de bloqueio de escrita para usuários sem controle total.
<h4>Permissões NTFS <img width="1023" height="767" alt="Acesso negado CTFS pasta" src="https://github.com/user-attachments/assets/ad2ba915-cbb7-495b-a8f5-83bf1109b8ba" /></h4>
